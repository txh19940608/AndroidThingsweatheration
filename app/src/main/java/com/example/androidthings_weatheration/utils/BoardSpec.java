package com.example.androidthings_weatheration.utils;
...
public class BoardSpec {
    ...
    private static final String DEVICE_IMX7D_PICO="imx7d_picco";
    ...
    public String getPwm(int i){
        if(pwms==null||i>=pwms.length || pwms[i]==null){
            throw new IllegalArgumentException("PWM_" +i+ "pin not Supported Device: " + Build.DEVICE);
        }else {
            return pwms[i];
        }
    }
    ...
    public static String getI2cBus(){
        ...
        if(s!=null)
            ...
            throw new IllegalArgumentException("I2C pin not Supported Device: " + Build.DEVICE);
    }
    ...
    public static  String getUartName(){
        ...
        if(s!=null)
            ...
            throw new IllegalArgumentException("UART pin not Supported Device: " + Build.DEVICE);
    }
    ...
    public static String getSpiBus(){
        ...
        if(s!=null)
            ...
            throw new IllegalArgumentException("SPI pin not Supported Device: " + Build.DEVICE);
    }
